...
/**
 * This class is a child of {@link CheckComboBox <T>} which automatically loads predefined
 * style sheets at construction of an object of this class.
 */
public class StyledCheckComboBox<T> extends CheckComboBox<T> implements StyledNode {

    /**
     * Instance field that contains all style sheets of this object.
     * Contains default value if assigned.
     */
    private final String[] STYLE_SHEETS = { COMBO_BOX_STYLE_SHEET, SCROLL_BAR_STYLE_SHEET, CHECK_BOX_STYLE_SHEET };

    /**
     * Default constructor calls parent constructor <code>super()</code>
     * and initializes style sheets.
     */
    public StyledCheckComboBox() {
        super();
     ...
     */
    public StyledCheckComboBox(final ObservableList<T> items) {
        super(items);
        initializeStyleSheets();
    }
